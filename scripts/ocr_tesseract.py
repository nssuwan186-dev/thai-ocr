#!/usr/bin/env python3
"""
Thai Hotel Registration Form OCR - Tesseract (Free & Stable)
ใช้ Tesseract OCR อ่านฟอร์มทะเบียนผู้เข้าพัก
"""
...
def run_ocr(folder, output):
    ...
    for img_path in tqdm(images, desc="OCR"):
        ...
        try:
            ...
            hotel_data['confidence'] = '0.85'  # Tesseract typical accuracy
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Thai Hotel Form OCR - Tesseract")
