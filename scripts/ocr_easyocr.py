#!/usr/bin/env python3
"""
Thai Hotel Registration Form OCR - EasyOCR (Free)
ใช้ EasyOCR อ่านฟอร์มทะเบียนผู้เข้าพัก
"""
...
def run_ocr(folder, output):
    # Initialize EasyOCR (Thai + English)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Thai Hotel Form OCR - EasyOCR")
